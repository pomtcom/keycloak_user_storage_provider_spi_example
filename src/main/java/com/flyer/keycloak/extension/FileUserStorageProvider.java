...
public class FileUserStorageProvider implements
    ...
    public boolean isValid(RealmModel realm, UserModel user, CredentialInput input) {
        ...
        /*Keycloak update UserCredentialModel, then the below code is required for some change.
        refer https://stackoverflow.com/questions/59040133/keycloak-example-the-method-getvalue-is-undefined-for-the-type-usercredentia*/
...
//        UserModel userModel = createAdapter(realm, user);
        ...
        log.infov("Adding new user to file repository: username={0}", username);
        User user = new User("defaultfirstname","defaultlastname","defaultemail@defualt.com","defualt message");
        user.setUsername(username);
        userRepository.insertUser(user);
        UserModel userModel = createAdapter(realm, user);
        return userModel;
